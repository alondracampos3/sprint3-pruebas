...
import { AdaptableComponent } from "./adaptable/adaptable.component";
...
@Component({
  selector: 'app-root',
  imports: [AdaptableComponent, HeaderComponent, FooterComponent, CartComponent],
  templateUrl: './app.component.html',
  styleUrl: './app.component.css'
})
export class AppComponent {
  title = 'PruebasSprint03';
  ...
  FnhandleFormatChange(isList: boolean) {
    this.isListFormat = isList;
